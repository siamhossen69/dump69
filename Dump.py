...
def login_cookie():
	print("")
	#testi_ua()
	x = f"{P2}Don't use your personal account to make cookies"
	vprint(panel(x,style=f"{H3}"))
	cookie = str(input(f"{garis} Enter your cookie :"+H+" "))
	with requests.Session() as xyz:
		try:
			jalan(f"{garis} Logging your Token... ")
			...
			vprint(panel(x,style=f"{H3}"))
			input(f"{garis} Press Enter to continue.. ")
			menu()
		except requests.exceptions.ConnectionError:
			x=f"{P2}koneksi internet bermasalah"
			vprint(panel(x,style=f"{H3}"))
